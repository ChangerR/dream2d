...
******************************************************************************************************/
#ifndef __D_DREAM2D_CANVANSLOADER
#define __D_DREAM2D_CANVANSLOADER
#include "ICanvans.h"
class CCanvansLoader
{
public:
	CCanvansLoader() {

	}
	virtual ~CCanvansLoader() {

	}
public:
	static ICanvans* LoadBmpFile(const char* filename);
};
